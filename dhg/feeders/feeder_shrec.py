...
from feeders.augmentations import *
...
class Feeder(Dataset):
    def __init__(self, data_path, pipeline, split='train',is_14=True):
        ...
        self.split = split
        self.is_14 = is_14
        self.transformers= [import_class('feeders.augmentations'+'.'+p.pop('type'))(**p) for p in pipeline]
    ...
    def load_pkl_annotations(self):
        ...
        self.total_frames = data[self.split][3]
